...
export function ProductCard({ product, index, showRating = true, variant = 'card' }: ProductCardProps) {
  ...
  if (variant === 'list') {
    return (
      <>
        ...
        >
          <div 
            className="flex items-center gap-4 p-3 rounded-xl bg-white/50 backdrop-blur-sm border border-transparent hover:border-primary/20 hover:bg-white hover:shadow-md transition-all cursor-pointer group relative overflow-hidden"
          ...
          >
            ...
            <div className="flex-1 min-w-0 py-1">
              <div className="flex justify-between items-start">
                <h3 className="font-bold text-base truncate pr-2 text-foreground/90">{product.name}</h3>
