      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-white text-lg">{t('product')}</h3>
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-white text-lg">{t('company')}</h3>
            <ul className="space-y-2 text-sm text-zinc-400">
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-white text-lg">{t('legal')}</h3>
            <ul className="space-y-2 text-sm text-zinc-400">
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <Link href="#" aria-label="Facebook" className="text-zinc-400 hover:text-white transition-colors">
              <Facebook className="h-5 w-5" />
            </Link>
            <Link href="#" aria-label="Twitter" className="text-zinc-400 hover:text-white transition-colors">
